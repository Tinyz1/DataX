...
public class Engine {
    ...
    public void start(Configuration allConf) {
        ...
        long instanceId;
        int taskGroupId = -1;
        String jobModel = null == RUNTIME_MODE ?
                allConf.getString(CoreConstant.DATAX_CORE_CONTAINER_JOB_MODE) : RUNTIME_MODE;
        if (isJob) {
            allConf.set(CoreConstant.DATAX_CORE_CONTAINER_JOB_MODE, jobModel);
