...
public class CoreConstant {
    ...
    public static String DATAX_HOME = getDataxHome(null);
    ...
    public static String  getDataxHome(String dataxHome){
        if (null == dataxHome) {
            dataxHome = System.getProperty("datax.home");
        }
        return  dataxHome;
    }

    public static void reLoadDataXHome(String dataxHome) {
        DATAX_HOME =  getDataxHome(dataxHome);
        DATAX_CONF_PATH = StringUtils.join(new String[]{
                DATAX_HOME, "conf", "core.json"}, File.separator);
        DATAX_CONF_LOG_PATH = StringUtils.join(new String[]{
                DATAX_HOME, "conf", "logback.xml"}, File.separator);
        DATAX_SECRET_PATH = StringUtils.join(new String[]{
                DATAX_HOME, "conf", ".secret.properties"}, File.separator);
        DATAX_PLUGIN_HOME = StringUtils.join(new String[]{
                DATAX_HOME, "plugin"}, File.separator);
        DATAX_PLUGIN_READER_HOME = StringUtils.join(
                new String[]{DATAX_HOME, "plugin", "reader"}, File.separator);
        DATAX_PLUGIN_WRITER_HOME = StringUtils.join(
                new String[]{DATAX_HOME, "plugin", "writer"}, File.separator);
        DATAX_BIN_HOME = StringUtils.join(new String[]{
                DATAX_HOME, "bin"}, File.separator);
        DATAX_JOB_HOME = StringUtils.join(new String[]{
                DATAX_HOME, "job"}, File.separator);
        DATAX_STORAGE_TRANSFORMER_HOME = StringUtils.join(
                new String[]{DATAX_HOME, "local_storage", "transformer"}, File.separator);
        DATAX_STORAGE_PLUGIN_READ_HOME = StringUtils.join(
                new String[]{DATAX_HOME, "local_storage", "plugin", "reader"}, File.separator);
        DATAX_STORAGE_PLUGIN_WRITER_HOME = StringUtils.join(
                new String[]{DATAX_HOME, "local_storage", "plugin", "writer"}, File.separator);
    }
